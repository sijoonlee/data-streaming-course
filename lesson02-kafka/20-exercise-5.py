    ...
    c = Consumer(
        {
            ...
            # this will apply only when consumer application starts for the first time
            # if you run this app again, the app will take the offset where the app left
        }
    )
...
# https://docs.confluent.io/platform/current/clients/confluent-kafka-python/#consumer
